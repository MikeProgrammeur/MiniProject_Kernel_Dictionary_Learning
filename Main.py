...
sg.display_signal( signals1= signals_r1, signals2=signals_r2, title="Representation of the two synthetic classes on the R² plane",class1name="Unit circle",class2name="Centered circle of radius 2")
